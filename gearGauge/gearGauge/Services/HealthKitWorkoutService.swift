...
final class HealthKitWorkoutService: WorkoutServiceProtocol {
    ...
    func requestAccess() async throws {
        ...
        // we have no means of determining if we DON'T have access, best bet is to just query and see what happens
        // a query without access still returns a NIL error (and empty sample result)
        hasAccess = true
    }
