I have an iOS app which I have been working on. However my design overall is not well thought out. Here is a UI/UX overview of what the app does. Could you put together a system which does this, and also if there are other ideas, suggest those at the end as well.
